...
$(document).ready(function() {
	...
	if (!ua("ie7") && !ua("ie8")) {
		...
		$("#UltraGlobalNavi").before('<p id="GlobalNaviTopButtonSP" class="BtnOpen ShowRWD"><a href="javascript:void(0);"><img src="images/icon_navi_global.gif" width="21" height="21" alt="Menu" /></a></p>');
